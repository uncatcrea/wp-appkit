define( function( require ) {
     ...
     *
     * @return  String  launch_route   Launch route filled with the actual Backbone route (#host + path). Ex: #single/posts/7
     */
    deepLink.getLaunchRoute = function() {
        ...
        if( wpak_open_url.length ) {
            ...
            if( parsed_url.host.length > 0 ) {
                ...
                Utils.log( 'Launch route updated from deep link URL', { launch_route: launch_route, wpak_open_url: wpak_open_url });
