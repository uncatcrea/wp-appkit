						...
						<div>
							<ul>
								<?php foreach( $default_themes as $slug => $theme ):
									if( !is_dir( WpakThemes::get_default_themes_directory() . '/' . $slug ) ) {
										continue;
									}
									?>
									<li>
										<a href="<?php echo WpakThemes::get_default_themes_directory_uri() . '/' . $slug; ?>"><?php echo $theme['name'] . ' (' . $theme['version'] . ')'; ?></a>
									</li>
								<?php endforeach; ?>
							</ul>
						</div>
