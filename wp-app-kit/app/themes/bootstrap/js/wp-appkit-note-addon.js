define( [ 'jquery', 'core/theme-app', 'addons/wp-appkit-note/wpak-note', 'theme/js/bootstrap.min' ], function( $, App, WpakNote ) {
	...
	*/
	...
	WpakNote.setActions({
		display_first_box: function(){
			...
			$modal_footer.html(
				'<button id="first-box-yes" type="button" class="btn btn-primary">'+ $('#wpak-note-first-box-yes').html() +'</button>'+
				'<button id="first-box-no" type="button" class="btn btn-default" >'+ $('#wpak-note-first-box-no').html() +'</button>'+
				'<button id="first-box-later" type="button" class="btn btn-default" >'+ $('#wpak-note-first-box-later').html() +'</button>'+
				'<button id="first-box-dont-ask-again" type="button" class="btn btn-default" >'+ $('#wpak-note-first-box-dont-ask-again').html() +'</button>'	
			);
			$modal.modal();
		},
